        ...
        <ol class="breadcrumb">
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="text-center">PERPUSTAKAAN ONLINE | TAMBAH DAFTAR BUKU</h2>
                </div>
                <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="cover" class="" id="cover">
                    </div>
                    <div class="mb-3">
                   ...
                   <a href="index.php" class="btn btn-success"><i class="i bi-arrow-counterclockwise"></i></a>
